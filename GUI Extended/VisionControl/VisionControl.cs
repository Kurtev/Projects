  ...
  public partial class VisionControl : UserControl
  {
    ...
    private void AttachToJobManager(bool attach)
    {
      ...
      if (attach)
      {
        ...
        mJM.UserResultAvailable += new CogJobManager.CogUserResultAvailableEventHandler(mJM_UserResultAvailable1);
   ...
   private void mJM_UserResultAvailable(object sender, CogJobManagerActionEventArgs e)
    ...
    private void timer1_Tick(object sender, EventArgs e)
    {
         ...
         label_time.Text = dateTime.TimeOfDay.ToString();
   
    }
     //Method for multiple screen 
    delegate void mJM_UserResultAvailableDelegate(object sender, CogJobManagerActionEventArgs e);
    delegate void mJM_StoppedDelegate(object sender, CogJobManagerActionEventArgs e);

    void mJM_UserResultAvailable1(object sender, CogJobManagerActionEventArgs e)
    {
        ...
        // Get last record
        ICogRecord topRecord = mJM.UserResult();
        String result1 = "";
        String name = "";

        // Get Job name from last record
        name = topRecord.SubRecords["JobName"].Content.ToString();

        result1 = name + " - Tag: ";
        result1 = result1 + topRecord.SubRecords["UserResultTag"].Content.ToString();
        result1 = result1 + " Status: " + topRecord.SubRecords["RunStatus"].Content.ToString();


        ICogRunStatus status = topRecord.SubRecords["RunStatus"].Content as ICogRunStatus;
        result1 = result1 + " Time: " + status.TotalTime.ToString("0.00");
        int jobIndex = Utility.GetJobIndexFromName(mJM, name);
        // note - ignore unknown job names
        if (jobIndex >= 0)
        {
            // push the result into the appropriate history queue
            mHistoryCollection[jobIndex].AddNewUserResult(topRecord);

            // pass the result on to any listeners
            VisionControlUserResultAvailableEventHandler delegateCopy = VisionControlUserResultAvailable;
            if (delegateCopy != null)
            {
                delegateCopy(this, new VisionControlUserResultAvailableEventArgs(jobIndex, topRecord));
            }
    ...
    private void button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            mail.From = new MailAddress("checkinreport@gmail.com");
            mail.To.Add(textBox9.Text);

            mail.Subject = "Guala Report";
            mail.Body = "Best Regards http://www.checkin-bg.com";

            System.Net.Mail.Attachment attachment1;

            attachment1 = new System.Net.Mail.Attachment("C:\\Report\\JobResults.csv");

            mail.Attachments.Add(attachment1);
  

            SmtpServer.Port = 587;
            SmtpServer.Credentials = new System.Net.NetworkCredential("checkinreport", "checkin1234");
    ...
    private void button3_Click(object sender, EventArgs e)
    {
      ...
      //Read from text file`s to set menuStrip item 
    void initMenuStrip()
    {
        string text1 = System.IO.File.ReadAllText(@"C:\Team\Fitter10.txt");
        string text2 = System.IO.File.ReadAllText(@"C:\Team\Fitter11.txt");
        string text3 = System.IO.File.ReadAllText(@"C:\Team\Fitter12.txt");

        ivanIvanovToolStripMenuItem.Text = text1;
        stoqnIvanovToolStripMenuItem.Text = text2;
        aleksandurDimitrovToolStripMenuItem.Text = text3;

    }

          private void textBox_JobN_TotalIterations_TextChanged(object sender, EventArgs e)
         {
             
           
             //Write Summary statistic into JobSummary.csv
             using (StreamWriter writer = new StreamWriter("C:\\Report\\JobSummary.csv", false))
             {
            ...
            using (StreamWriter sw = new StreamWriter("C:\\Report\\JobResults.csv"))
            {
            //Use writeline methode to write the text
            sw.Write("Twistoff Report");
            sw.Write(";");
            sw.WriteLine(";");
            sw.WriteLine("Inspection ; Total ; Accepts ; Rejects");
            sw.Write(label9.Text);
            sw.Write(";");
            sw.Write(textBox_JobN_TotalIterations.Text);
            sw.Write(";");
            sw.Write(textBox_JobN_TotalAccept.Text);
            sw.Write(";");
            sw.Write(textBox_JobN_TotalReject.Text);
    ...
    private void ivanIvanovToolStripMenuItem_Click(object sender, EventArgs e)
    {
        button_ResetStatisticsForAllJobs.PerformClick();
      
        string s = ivanIvanovToolStripMenuItem.Text;
        using (StreamWriter writer = new StreamWriter("C:\\Report\\JobResults1.csv", false))
        {
            ...
            writer.WriteLine(date);
            writer.WriteLine(s);
            writer.Write("Defect Type");
            writer.Write(";");
            writer.Write("Defect Number");
            writer.Write(";");
    ...
    private void stoqnIvanovToolStripMenuItem_Click(object sender, EventArgs e)
    {
        button_ResetStatisticsForAllJobs.PerformClick();
       
        string s = stoqnIvanovToolStripMenuItem.Text;
        using (StreamWriter writer = new StreamWriter("C:\\Report\\JobResults1.csv", false))
        {
    ...
    private void aleksandurDimitrovToolStripMenuItem_Click(object sender, EventArgs e)
    {
        button_ResetStatisticsForAllJobs.PerformClick();

        string s = aleksandurDimitrovToolStripMenuItem.Text;
        using (StreamWriter writer = new StreamWriter("C:\\Report\\JobResults1.csv", false))
        {
      ...
      //Fill ComboBox fitter items
    void ComboFitterItem()
    {
        string s = ivanIvanovToolStripMenuItem.Text;
        string t = stoqnIvanovToolStripMenuItem.Text;
        string v = aleksandurDimitrovToolStripMenuItem.Text;
    ...
    private void button12_Click(object sender, EventArgs e)
    {
        ...
        if (textBox66.Text != "")
        {
            switch (ind)
            {
                case 1: ivanIvanovToolStripMenuItem.Text = textBox66.Text;
                    using (StreamWriter writer = new StreamWriter("C:\\Team\\Fitter10.txt", false))
                    {
                        writer.Write(textBox66.Text);

                    }
                    break;
                case 2: stoqnIvanovToolStripMenuItem.Text = textBox66.Text;
                    using (StreamWriter writer = new StreamWriter("C:\\Team\\Fitter11.txt", false))
                    {
                        writer.Write(textBox66.Text);

                    }
                    break;
                case 3: aleksandurDimitrovToolStripMenuItem.Text = textBox66.Text;
                    using (StreamWriter writer = new StreamWriter("C:\\Team\\Fitter12.txt", false))
                    {
                        writer.Write(textBox66.Text);
    ...
    private void comboBox6_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (cnt == 1)
        {
            ...
            {
                ivanIvanovToolStripMenuItem.Text = "Add New Member";
                ind = 1;
            }
            if (comboBox6.SelectedIndex == 1)
            {
                stoqnIvanovToolStripMenuItem.Text = "Add New Member";
                ind = 2;
            }
            if (comboBox6.SelectedIndex == 2)
            {
                aleksandurDimitrovToolStripMenuItem.Text = "Add New Member";
                ind = 3;
            }
    ...
    {
        if (MessageBox.Show("Are you sure ?", "Delete Team Member", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
        {
            cnt = 1;
    ...
    {
        string str = @"C:\Report\SavedImages";
        Process process = new Process();
        process.StartInfo.FileName = str;
        process.Start();
    }
      //get diameter of each product
  
    //load JobResults1.xlsm
    private void button8_Click(object sender, EventArgs e)
    {
        string str = @"C:\Report\JobResults1.xlsm";
        Process process = new Process();
        process.StartInfo.FileName = str;
        process.Start();
      
    }
    //Load JobResults2.xlsm
    private void button9_Click(object sender, EventArgs e)
    {
        string str = @"C:\Report\JobResults2.xlsm";
        Process process = new Process();
        process.StartInfo.FileName = str;
        process.Start();
    }
